...
use crate::components::{FilmCard, FilmModal, Footer, Header};
mod components;
mod models;
fn main() {
...
fn App(cx: Scope) -> Element {
    ...
    cx.render(rsx! {
       main {
           class: "relative z-0 bg-stone-950 w-screen h-auto min-h-screen flex flex-col justify-start items-stretch",
           Header {}
           section {
